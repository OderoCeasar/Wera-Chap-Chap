-- The category list is reference data, not demo data: tasks and tasker skills
-- both foreign-key to it, so every environment needs these rows. Demo accounts
-- and tasks stay in the seed package behind SEED_DEMO.
